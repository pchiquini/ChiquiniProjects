...
messageType = '1'                                                  #most sign bit. excercise 1
request = '1'                                                   	 #next-most sign bit. set: 0-request 1-response
first16_Field1_int_a = 49508 #1100000101100100
first16_Field1_binary = bin(49508)[2:].zfill(16)
